...
def upgrade() -> None:
    ...
    if "albums" not in existing_tables:
        op.create_table(
            ...
            sa.Column(
                "dynamic_filters", postgresql.JSONB(astext_type=sa.Text()), nullable=True
            ),
            sa.Column(
                "created_at",
                sa.DateTime(timezone=True),
    ...
    if "face_clusters" not in existing_tables:
        op.create_table(
            "face_clusters",
            sa.Column("id", sa.Uuid(), nullable=False),
            sa.Column("event_id", sa.Uuid(), nullable=False),
    ...
    if "gallery_cache" not in existing_tables:
        op.create_table(
            "gallery_cache",
            sa.Column("event_id", sa.Uuid(), nullable=False),
            sa.Column(
                "cached_payload", postgresql.JSONB(astext_type=sa.Text()), nullable=True
            ),
    ...
    if "qr_codes" not in existing_tables:
        op.create_table(
            "qr_codes",
            sa.Column("id", sa.Uuid(), nullable=False),
            sa.Column("event_id", sa.Uuid(), nullable=False),
    ...
    if "face_consents" not in existing_tables:
        op.create_table(
            "face_consents",
            sa.Column("id", sa.Uuid(), nullable=False),
            sa.Column("event_id", sa.Uuid(), nullable=False),
    ...
    if "album_media" not in existing_tables:
        op.create_table(
            "album_media",
            sa.Column("event_id", sa.Uuid(), nullable=False),
            ...
            sa.ForeignKeyConstraint(
                ["event_id", "media_id"], ["media.event_id", "media.id"], ondelete="CASCADE"
            ),
    ...
    if "face_embeddings" not in existing_tables:
        op.create_table(
            ...
            sa.ForeignKeyConstraint(["event_id"], ["events.id"], ondelete="CASCADE"),
            sa.ForeignKeyConstraint(
                ["uploader_consent_id"], ["face_consents.id"], ondelete="CASCADE"
            ),
            sa.PrimaryKeyConstraint("id"),
        )
